...
8. **Performance and risk behavior**: NAV and market returns when available, benchmark/category context, tracking difference/error, volatility, beta, drawdowns, stress-period behavior where history supports it, and tracking proxy versus benchmark symbols when available.
9. **SEC filings review**: prospectus/summary prospectus, SAI, annual/semiannual reports, N-PORT, N-CEN, 497/497K changes, Form 8937 only if deterministically available, and material closure/fee/strategy/risk updates.
