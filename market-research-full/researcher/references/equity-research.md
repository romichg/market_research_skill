...
3. **Market snapshot and positioning**: use normalized price, volume, 52-week range, market cap, valuation snapshot, technical signals, news/sentiment, and analyst/estimate data only when returned by configured free APIs. Mark short interest and analyst data as gaps when unavailable.
...
10. **Valuation context**: market cap, enterprise value, P/E, P/S, P/B, EV/EBITDA, dividend yield, buyback yield, FCF yield, and peer multiples only when deterministic or procedurally sourced. Do not invent price targets.
11. **Catalysts and monitoring inputs**: next earnings date, dividend dates, recent material filings, technical levels, support/resistance approximations from local price extrema, product/regulatory/company events, bull/base/bear variables, key monitor list, and invalidation candidates.
12. **Risks**: business, financial, regulatory, cyclicality, customer/supplier concentration, competition, valuation, FX, geopolitical, litigation, cybersecurity, governance, strategic-partner/platform dependency, and ADR-specific risks. For AI-heavy companies, search filings deterministically for AI/cloud/GPU/model/capex/platform/regulation keywords and surface excerpts.
13. **Data gaps and confidence**: copy unresolved deterministic gaps and add procedural-source gaps. Distinguish unavailable free data from collection failures and stale data.
