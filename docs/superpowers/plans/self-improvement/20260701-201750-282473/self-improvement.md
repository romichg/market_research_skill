...
Inputs to inspect:
- Run root: `runtime/market-research-batch-20260701`
  - Summary: `runtime/market-research-batch-20260701/research-loop-summary.json`
  - Loop notes: `runtime/market-research-batch-20260701/loop-skill-issues.md`
  - Operator notes: `runtime/market-research-batch-20260701/operator-notes.md`
...
Write outputs under:
- `docs/superpowers/plans/self-improvement/20260701-201750-282473/self-improvement-ideas.md`
- `docs/superpowers/plans/self-improvement/20260701-201750-282473/self-improvement-plan.md`
- `docs/superpowers/plans/self-improvement/20260701-201750-282473/self-improvement.json`
