...
Inputs to inspect:
- Run root: `runtime/market-research-batch-20260623`
  - Summary: `runtime/market-research-batch-20260623/research-loop-summary.json`
  - Loop notes: `runtime/market-research-batch-20260623/loop-skill-issues.md`
  - Operator notes: `runtime/market-research-batch-20260623/operator-notes.md`
...
Write outputs under:
- `docs/superpowers/plans/2026-06-23-qubt-batch-self-improvement-ideas.md`
- `docs/superpowers/plans/2026-06-23-qubt-batch-self-improvement-plan.md`
- `docs/superpowers/plans/2026-06-23-qubt-batch-self-improvement.json`
